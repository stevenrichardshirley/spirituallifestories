...
<div class="width_setter">
    ...
    <div class="column75">
        ...
        <?php if ( $category->description != '' ) { ?>
            <div id="description" class="descriptionText"><?php echo $category->description; ?></div>
        <?php } else { ?>
            <div id="description" class="descriptionText">Click on Green Check Marks to see friends questions and responses.</div>
        <?php } ?>
    </div>
    <div class="column25">
