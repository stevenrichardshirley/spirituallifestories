<?php
    ...
    $activated_user = ($user->is_activated_user() || ($user->activated_free_days() > 0));
...
<div id="breadcrumb">
    <div class="width_setter">
        <ul>
            ...
            <li><?if(!$mode_readonly){?><a href="<?php echo utils::url('home'); ?>library/my-story/"><?}?><?php echo $user_first_name; ?>'s life story</a></li>
...
-->
        ...
        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
            ...
            <div class="form_row">
                ...
                else
                {
                    ...
                    {
                    ?>
                        <div style="padding:15px;background-color:#FFA;text-align:center;font-size:18px;line-height:140%">
                            <b>Your account is not activated yet. <br />Click on the button below and signup now! <br /><font size=2>$100/per year</font></b><br /><br />
                            <iframe src="<?=utils::url('theme')?>/integration/paypal_pay.php" frameborder=0 width=200 height=70></iframe>
                        </div>
                    <?    
                    }
                    else
            ...
            <?if(!$mode_readonly && $activated_user){?>
            ...
            <?} else if ($mode_readonly) {?>
                ...
                <div class="form_row" style="overflow:hidden;width:auto;text-align:left;padding:20px;background-color:rgba(255,255,50,0.5)">
                    <div style="float:left;width:60%">
                        <b>You can join LifeStories by clicking on this link!  Join, it's FREE and you can start writing your story AND sharing it!</b>
                    </div>
        ...
        <?if(!$mode_readonly){?>
            <div class="sidebar" id="shareDiv" <?if($answer[0]->id <= 0){?>style="display:none"<?}?>>
              ...
              <a href="https://twitter.com/intent/tweet?text=Check my Life Stories&url=http://<?=$_SERVER['HTTP_HOST'].ROOT_DIRECTORY?>/questions/question-<?=$question_id?>-0-<?=$answer[0]->id?>" id="linkTwitter" target="_blank"><img src="<?php echo utils::url('theme'); ?>images/twitter.png" border=0 /></a>
            </div>
        <?}?>
        ...
        <div class="sidebar">
            ...
            if (!$mode_readonly && ($countphotos < total_photos_limit || $photo_count > 0) && $activated_user)
            {
            ?>
