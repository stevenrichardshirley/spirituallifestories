...
<?php
	...
	if( isset($_GET['id']) && isset($_GET['cmd']) ) {
	    ...
	    $messagepass =  "Event deleted! Hope you meant to do that, because it is gone.";
	}
...
?>
	...
	<div id="title_bar">
		<h3>Events</h3>
		<div class="add_button_holder"><a href="event_manage.php">Add New Event &raquo;</a></div>	
	</div>
	...
	<div class="innerpad">
	    ...
	    <table width="100%" border="0" cellspacing="0" id="data_sort">
			...
			for($i = 0; $i < $numofrows; $i++) {
			    ...
			    echo "<tr>";
			    echo "<td><a href=\"event_manage.php?id={$row['id']}\"><img src=\"images/edit.png\" alt=\"Edit\" /></a></td>";
			    echo "<td><a href=\"event_manage.php?id={$row['id']}\">{$row['title']}</a></td>";
			    echo "<td>" .date('m/d/y, g:ia', strtotime($row['date'])). "</td>";
