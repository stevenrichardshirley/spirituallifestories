<?php
    ...
    $friend_id = intval($parts[count($parts)-1]);
...
<div id="main" role="main">
    <div class="width_setter">
        ...
        <input type="hidden" name="user_id" value="<?php echo $user->user_id; ?>" />
            <div class="column100" style="padding-left:10px">
            ...
            <div class="column75">
                ...
                ?>
                <div class="form_row">
                    <textarea name="content" id="contrib" tabindex="1" onkeyup="doShowSaveYourContent()"></textarea>
                </div>
                
                <div class="form_row">
                    <input type="submit" name="submit" value="Save Question" class="form_button" />
                    <div id="divSaveYouContentTip" style="color:red;margin-top:10px;display:inline;margin-left:20px;visibility:hidden;font-weight:bold">< &nbsp; Click on this button to save your content</div>
                </div>
    ...
    function()
    {
        $('#contrib').redactor({
            keyupCallback: function(e){
                        jQuery('#divSaveYouContentTip').css('visibility','visible');
            },
