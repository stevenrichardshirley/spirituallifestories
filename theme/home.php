...
-->
                ...
                <ul>
                    ...
                    <?php } else { ?>
                        ...
                        $(document).ready(function(){
                            setTimeout(function(){$('#divSignUpCall').fadeIn(500);}, 3000);
                        });
                        </script>
            ...
            <div style="display:none" id="divSignUpCall">
                <div style="cursor:pointer;position:absolute;top:97px;left:46%;background-color:#FFEC03;border:1px solid #000;padding:8px 15px;font-size:15px;font-weight:bold;color:#000" onclick="document.location.href='register'">
                    Begin writing your spiritual life story for <u>FREE</u>
                </div>
