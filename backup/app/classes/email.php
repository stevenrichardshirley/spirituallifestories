...
class email
{
	...
	public function invite($name, $email, $book_id) {
		      ...
		      <td width="180">
		      	...
		      	<img src="'.$book_cover.'" style="width: 178px; height: 273px; z-index: 1;" />
					<a style="width: 178px;
							  ...
							  z-index: 10;
							  "
						href="http://spirituallifestories.com/register">'.$book->title.'</a>
					</div>
		      </td>
		      <td width="350" style="padding: 0 20px;">
		      	<h3>You have been invited to read the spiritual life story of your friend!</h3>
		      	<p><strong>So, what does this mean?</strong></p>
		      	<p>Your friend has signed up at SpiritualLifeStories.com and is working on writing their spiritual life story one question at a time. They would like for you to help them. By clicking the button below you can login, read your friend&#39;s content, and add content to collaborate!</p>
		  ...
		  <table style="margin: 10px;" width="500px">
		    <tr>
		      <td style="padding: 20px 0;">
		        <a href="http://spirituallifestories.com/register/" style="background: #B7A1C9; padding: 15px 20px; color: #fff; text-transform: uppercase;">Share your answers Now!</a>
		      </td>
		    </tr>
		  </table>
